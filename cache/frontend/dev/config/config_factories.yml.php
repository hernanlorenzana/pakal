...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/home/hernan/pakal/log/frontend_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/home/hernan/pakal/cache/frontend/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/home/hernan/pakal/apps/frontend/i18n',
));
...
$this->factories['routing'] = new $class($this->dispatcher, $cache, sfToolkit::arrayDeepMerge(array('auto_shutdown' => false, 'context' => $this->factories['request']->getRequestContext()), sfConfig::get('sf_factory_routing_parameters', array (
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/home/hernan/pakal/cache/frontend/dev/template',
  'lifetime' => 86400,
  'prefix' => '/home/hernan/pakal/apps/frontend/template',
)));
